<x-layout title="PIXL | Feed">
    ...
    <main class="-mx-4 flex grow flex-col gap-4 overflow-y-auto px-4 py-4">
        ...
        <div class="border-pixl-light/10 mt-8 flex items-start gap-4 border-b pb-4">
            <a href="/profile" class="shrink-0"><img src="/images/adrian.png" alt="Avatar for Adrian"
        ...
        <ol class="mt-4">
            ...
            <li class="flex items-start gap-4 not-first:pt-2.5">
                <a href="/profile" class="shrink-0"><img src="/images/adelle.png" alt="Avatar for Adelle"
                        class="size-10 object-cover" /></a>
                <div class="border-pixl-light/10 grow border-b pt-1.5 pb-5">
                    <div class="flex items-center justify-between gap-4">
                        <div class="flex items-center gap-2.5">
                            <p><a class="hover:underline" href="/profile">Adelle</a></p>
                            <p class="text-pixl-light/40 text-xs">2h</p>
                            <p class="text-xs">
                                <a class="hover:text-pixl-light/60 text-pixl-light/40" href="/profile">@ad-elle</a>
                            </p>
                        </div>
                        <button class="group flex gap-[3px] py-2" aria-label="Post options">
                            <span class="bg-pixl-light/40 group-hover:bg-pixl-light/60 size-1"></span><span
                                class="bg-pixl-light/40 group-hover:bg-pixl-light/60 size-1"></span><span
            ...
            <!-- More feed items... -->
            <li class="flex items-start gap-4 not-first:pt-2.5">
                <a href="/profile" class="shrink-0"><img src="/images/michael.png" alt="Avatar for Adelle"
                        class="size-10 object-cover" /></a>
                <div class="border-pixl-light/10 grow border-b pt-1.5 pb-5">
                    <div class="flex items-center justify-between gap-4">
                        <div class="flex items-center gap-2.5">
                            ...
                            <p class="text-xs">
                                <a class="hover:text-pixl-light/60 text-pixl-light/40" href="/profile">@mmich_jj</a>
                            </p>
                        </div>
                        <button class="group flex gap-[3px] py-2" aria-label="Post options">
                            <span class="bg-pixl-light/40 group-hover:bg-pixl-light/60 size-1"></span><span
                    ...
                    <!-- Reply -->
                    <ol class="border-pixl-light/10 mt-5 border-t">
                        <li class="group/li relative flex items-start gap-4 pt-4">
                            ...
                            <a href="/profile" class="isolate shrink-0"><img src="/images/simon-chilling.png"
                                    alt="Avatar for Alex" class="size-10 object-cover" /></a>
                            <div class="border-pixl-light/10 grow border-b pt-1.5 pb-5">
                                <div class="flex items-center justify-between gap-4">
                                    <div class="flex items-center gap-2.5">
                                        <p>
                                        ...
                                        <p class="text-xs">
                                            <a class="hover:text-pixl-light/60 text-pixl-light/40"
                                                href="/profile">@alex-in-paris</a>
                                        </p>
                                    </div>
                                    <button class="group flex gap-[3px] py-2" aria-label="Post options">
                                        <span class="bg-pixl-light/40 group-hover:bg-pixl-light/60 size-1"></span><span
        ...
        <footer class="mt-30 ml-14">
            ...
            <hr class="border-pixl-light/10 my-4 border-b" />
