<aside class="-mx-4 my-4 hidden w-80 shrink-0 overflow-y-auto px-4 lg:block">
    ...
    <div class="border-pixl-light/10 mt-10 border p-4">
        ...
        <ol class="mt-4 flex flex-col gap-4">
            ...
            <li class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-2.5">
                    <img class="size-8 object-cover" src="/images/anne.png" alt="Avatar of Alessia" />
            ...
            <li class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-2.5">
                    <img class="size-8 object-cover" src="/images/mr-anderson.png" alt="Avatar of Alessia" />
            ...
            <li class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-2.5">
                    <img class="size-8 object-cover" src="/images/michael.png" alt="Avatar of Alessia" />
